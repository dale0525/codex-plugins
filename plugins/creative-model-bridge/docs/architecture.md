...
`creative-model-bridge/0.1.12`. This stable product identifier is a transport
...
does not block uninstall. A consistent prior 0.1.5 through 0.1.11 owned image
