...
The default release version is 0.1.10; the repository deliberately does not
...
0.1.6, 0.1.7, 0.1.8, or 0.1.9 state is upgraded to 0.1.10 under the same byte-exact
