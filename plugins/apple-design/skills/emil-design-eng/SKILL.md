...
description: This skill encodes Emil Kowalski's philosophy on UI polish, component design, animation decisions, and the invisible details that make software feel great. Use only when the user explicitly mentions Emil Kowalski, animations.dev, or explicitly invokes this skill; do not trigger for generic UI polish, animation implementation, or code review.
---
