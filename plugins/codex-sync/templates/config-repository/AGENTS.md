...
Use native Codex subagents when broad reading, independent verification, or parallel work provides more value than dispatch overhead. Keep small known-file reads, final decisions, code changes, and user-facing conclusions in the main thread.
