...
class CreativeReleaseValidatorTests(unittest.TestCase):
    ...
    def test_checked_in_contract_matches_v019(self) -> None:
        self.assertEqual(release_validator.validate(ROOT, "creative-model-bridge-v0.1.9"), [])
    ...
    def test_provisioner_default_version_mismatch_fails(self) -> None:
        ...
        mismatched = text.replace("else { '0.1.9' }", "else { '0.1.7' }")
        errors = release_validator.validate_provisioner_contract(mismatched, "0.1.9")
    ...
    def test_provision_version_mismatch_fails(self) -> None:
        ...
        mismatched = text.replace('PROVISION_VERSION = "0.1.9"', 'PROVISION_VERSION = "0.1.7"', 1)
        errors = release_validator.validate_provision_version(mismatched, "0.1.9")
